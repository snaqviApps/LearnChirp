...
fun MyChirpPasswordTextFieldEmptyPreview() {
    MyChirpTheme {
        MyChirpPasswordTextField(
            ...
            title = "password",
            supportingText = stringResource(Res.string.password_must_be_9_characters)
            )
    }
}
...
fun MyChirpPasswordTextFieldFilledPreview() {
    MyChirpTheme {
        MyChirpPasswordTextField(
            modifier = Modifier
//                .width(300.dp),
                .width(350.dp),
            state = rememberTextFieldState("pre-filled password text"),
            onToggleVisibilityClick = { },
...
fun MyChirpPasswordTextFieldErrorPreview() {
    MyChirpTheme {
        MyChirpPasswordTextField(
            modifier = Modifier
                .width(350.dp),
            ...
            title = "password",
            isError = true,
            supportingText = stringResource(Res.string.password_error_message),
        )
    }
}
