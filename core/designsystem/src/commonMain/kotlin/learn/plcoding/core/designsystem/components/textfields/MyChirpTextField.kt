...
fun MyChirpTextField(
    ...
    state: TextFieldState,          // 'Compose-state', that is different than default Material-Design 'textField' that does not have 'reactive' support for its own flow-related
    // limitations, like it could react to a wrongly entered phrase instead of correct e.g: email
